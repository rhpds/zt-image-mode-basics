...
=== _Switch to the `Build host` terminal_

Open the `Containervile` for editing and to the end of the `+dnf install+` line, add `+vim+` to the list of packages installed.
